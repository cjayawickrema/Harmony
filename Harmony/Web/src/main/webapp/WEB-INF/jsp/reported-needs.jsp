            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="row need-search-filters">
                        ...
                        <div class="col-md-2 search-filter-wrapper">
                            <div class="form-group">                             
                                <label>
                                    View Mode
                                </label>
                                ...
                                <label class="radio-inline">
                                    <input checked="" type="radio" name="viewMode" value="map">Map
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="viewMode" value="list">List
                                </label>
                            </div>
                        </div>
                        <div class="col-md-2 search-filter-wrapper">
                            <div class="form-group">   
                                <input type="button" class="btn btn-default" onclick="searchNeeds()" value="Go"/>
                            </div>
                        </div>
                        <div class="col-md-2">
